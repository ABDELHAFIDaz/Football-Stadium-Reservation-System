...
<aside class="w-[230px] flex-shrink-0 bg-surface border-r border-neon/10 flex flex-col sticky top-0 h-screen">
  ...
  <div class="px-5 py-5 border-b border-neon/10">
    <div class="flex items-center gap-3">
      ...
      <div><div class="font-syne font-bold text-sm text-white">Admin</div><div class="text-[.7rem] text-neon/60">Super Admin</div></div>
    </div>
  </div>
  ...
  <div class="px-3 py-4 border-t border-neon/10">
    <a href="login.html" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm text-white/30 hover:text-white/60 transition-all"><span>🚪</span> Sign Out</a>
  </div>
</aside>
