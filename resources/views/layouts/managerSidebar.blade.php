<aside class="w-[280px] h-screen sticky top-0 flex-shrink-0 bg-[#0b120f] border-r border-white/5 flex flex-col">
    ...
    <div class="flex-1">
        ...
        <nav class="px-4 mt-6 flex flex-col gap-2">
            ...
            <a href="{{ route('manager.stadiums') }}" class="flex items-center gap-4 px-4 py-3 rounded-xl text-sm font-syne font-bold text-white/40 hover:text-white hover:bg-white/5 transition-all">
